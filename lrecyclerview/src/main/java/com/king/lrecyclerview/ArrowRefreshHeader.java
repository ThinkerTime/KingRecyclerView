...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private void initView() {
        // 初始情况，设置下拉刷新view高度为0
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.recycler_refresh_header, null);
...
//        addView(mContainer, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
        ...
        mHeaderTimeView.setText(getNowDate());
...
//        int ct = (int)((System.currentTimeMillis() - time.getTime())/1000);
        int ct = (int) ((System.currentTimeMillis() - sCurrentTimeMillis) / 1000);
